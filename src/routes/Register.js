...
class Register extends React.Component {
  ...
  async componentDidMount() {
    ...
    this.setState({
      endpoint: `http://${this.props.wanip}:8005/api/authr/register_user`
    });
  }
  ...
  onSubmit = e => {
    ...
    if (
      ...
      this.props
        .authrRequest(this.state.endpoint, {
      ...
      <div>
        <PageHeader>
          <Container>
            ...
            <p>
              This is an example signup form for{" "}
              <a href="https://github.com/alexvpickering/authr">authr</a>.
            </p>
          </Container>
        </PageHeader>
        <Container>
